...
class RoleController extends Controller {
   ...
   * @router get /backend/role_permissions/list
   */
  async findAll() {
    const { ctx, service } = this;
    // get请求参数转为数字类型
    ctx.helper.tools.queryParseInt(ctx.query, ['limit', 'offset','role_id']);
   ...
   * @router get /backend/role_permissions
   ...
   * @router post /backend/role_permissions
   ...
   * @router put /backend/role_permissions
   ...
   * @router delete /backend/role_permissions
   ...
   * @router post /backend/role_permissions/bulk_permission
   * @request body role_permissionBodyReq
   */
