...
class RoleController extends Controller {
   ...
   * @router get /backend/messages/list
   */
  async findAll() {
    const { ctx, service } = this;
    // get请求参数转为数字
    ctx.helper.tools.queryParseInt(ctx.query, ['limit', 'offset', 'receiver_id', 'is_read']);
   ...
   * @router delete /backend/messages
