...
class RoleController extends Controller {
   ...
   * @router get /backend/project_template_tasks/list
   */
  async findAll() {
    const { ctx, service } = this;
    // get请求参数转为数字类型
    ctx.helper.tools.queryParseInt(ctx.query, ['limit', 'offset', 'project_template_id']);
   ...
   * @router get /backend/project_template_tasks
   ...
   * @router post /backend/project_template_tasks
   ...
   * @router put /backend/project_template_tasks
   ...
   * @router delete /backend/project_template_tasks
