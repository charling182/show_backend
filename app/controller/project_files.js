...
class RoleController extends Controller {
   ...
   * @router get /backend/project_files/list
   */
  async findAll() {
    const { ctx, service } = this;
    // get请求参数转为数字类型
    ctx.helper.tools.queryParseInt(ctx.query, ['limit', 'offset', 'project_id']);
   ...
   * @router get /backend/project_files
   ...
   * @summary 创建 项目文件
   * @description 创建 项目文件
   * @router post /backend/project_files
   ...
   * @summary 更新 项目文件
   * @description 更新 项目文件
   * @router put /backend/project_files
   ...
   * @router delete /backend/project_files
