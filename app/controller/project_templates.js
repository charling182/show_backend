...
class RoleController extends Controller {
   ...
   * @router get /backend/project_templates/list
   */
  async findAll() {
   ...
   * @router get /backend/project_templates
   ...
   * @summary 创建 项目模板
   * @description 创建 项目模板
   * @router post /backend/project_templates
   ...
   * @summary 更新 项目模板
   * @description 更新 项目模板
   * @router put /backend/project_templates
   ...
   * @router delete /backend/project_templates
