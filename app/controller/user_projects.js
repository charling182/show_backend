...
class RoleController extends Controller {
   ...
   * @router get /backend/user_projects/list
   */
  async findAll() {
    const { ctx, service } = this;
    // get请求将参数类型转为number
    ctx.helper.tools.queryParseInt(ctx.query, ['limit', 'offset', 'user_id', 'project_id']);
   ...
   * @router get /backend/user_projects
   ...
   * @router post /backend/user_projects
   ...
   * @router put /backend/user_projects
   ...
   * @router delete /backend/user_projects
   ...
   * @router delete /backend/user_projects/quit
   * @request body user_projectBodyReq
   */
  async quit() {
    const { ctx, service } = this;
