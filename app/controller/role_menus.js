...
class RoleController extends Controller {
   ...
   * @router get /backend/role_menus/list
   */
  async findAll() {
   ...
   * @router post /backend/role_menus
   ...
   * @router delete /backend/role_menus
   ...
   * @router post /backend/role_menus/bulk_menu
