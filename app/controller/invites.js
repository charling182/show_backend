...
class RoleController extends Controller {
   ...
   * @router get /backend/invites/list
   */
  async findAll() {
   ...
   * @router get /backend/invites/valid
  ...
  async findValidOne() {
    ...
    ctx.helper.tools.queryParseInt(ctx.query, ['group_id'])
   ...
   * @router get /backend/invites/uuid
   ...
   * @summary 接受 邀请
   * @description 接受 邀请
   * @router put /backend/invites/accept
