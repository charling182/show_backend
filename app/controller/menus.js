...
class RoleController extends Controller {
   ...
   * @router get /backend/menus/list
   */
  async findAll() {
    const { ctx, service } = this;
    // get接口参数类型转化为数字,只能单个修改吗?好奇怪,
   ...
   * @summary 获取 用户菜单
   * @description 获取 用户菜单
   * @router get /backend/menus/user_menus
   */
  async userMenus() {
    const { ctx, service } = this;
